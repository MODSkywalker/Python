...
# ⚠️Vous n'avez pas besoin d'afficher les variables avec print, il suffit de récupérer les bonnes valeurs dans les variables 
# à partir des listes et avec les indices des éléments.
